  ...
  <section class="relative overflow-hidden bg-surface-container-low px-md py-xl">
    ...
    <div class="relative z-10 mx-auto flex max-w-container-max flex-col items-center text-center">
      ...
      <div class="flex flex-wrap justify-center gap-sm">
        <RouterLink class="cursor-pointer rounded-full bg-secondary-container/20 px-sm py-[4px] font-label-sm text-label-sm text-on-secondary-container transition-colors hover:bg-secondary-container/30" to="/jobs?category=software-engineering">Software Engineering</RouterLink>
        <RouterLink class="cursor-pointer rounded-full bg-secondary-container/20 px-sm py-[4px] font-label-sm text-label-sm text-on-secondary-container transition-colors hover:bg-secondary-container/30" to="/jobs?category=product-management">Product Management</RouterLink>
